...
struct MessageEnvelope {
  ...
  mutating func clearService() {_storage._service = nil}
  ...
  mutating func clearExpiration() {_storage._expiration = nil}
  ...
  mutating func clearMessageType() {_storage._messageType = nil}
  ...
  mutating func clearEncryptedMessage() {_storage._encryptedMessage = nil}
  ...
  mutating func clearSenderPublicKey() {_storage._senderPublicKey = nil}
  ...
  mutating func clearReceiverPublicKey() {_storage._receiverPublicKey = nil}
  ...
  mutating func clearIdentifier() {_storage._identifier = nil}
  ...
  mutating func clearNonce() {_storage._nonce = nil}
  ...
  mutating func clearPushNotification() {_storage._pushNotification = nil}
...
extension MessagePushNotification: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: MessagePushNotification) -> Bool {
    if self._message != other._message {return false}
    if self._action != other._action {return false}
    if self._title != other._title {return false}
...
extension MessageEnvelope: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: MessageEnvelope) -> Bool {
    if _storage !== other._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((_storage, other._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._encryptedMessage != other_storage._encryptedMessage {return false}
        if _storage._senderPublicKey != other_storage._senderPublicKey {return false}
        if _storage._receiverPublicKey != other_storage._receiverPublicKey {return false}
        if _storage._identifier != other_storage._identifier {return false}
        if _storage._nonce != other_storage._nonce {return false}
        if _storage._pushNotification != other_storage._pushNotification {return false}
...
extension MessageLink: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: MessageLink) -> Bool {
...
extension MessagePing: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: MessagePing) -> Bool {
    if self._ping != other._ping {return false}
    if unknownFields != other.unknownFields {return false}
    return true
  }
}
...
extension MessagePong: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: MessagePong) -> Bool {
    if self._pong != other._pong {return false}
    if unknownFields != other.unknownFields {return false}
    return true
  }
}
...
extension MessageAccountRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: MessageAccountRequest) -> Bool {
    if self._scope != other._scope {return false}
    if unknownFields != other.unknownFields {return false}
    return true
  }
}
...
extension MessageAccountResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: MessageAccountResponse) -> Bool {
    if self._scope != other._scope {return false}
...
extension MessagePaymentRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: MessagePaymentRequest) -> Bool {
    if self._scope != other._scope {return false}
    if self._network != other._network {return false}
    if self._address != other._address {return false}
...
extension MessagePaymentResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: MessagePaymentResponse) -> Bool {
    if self._scope != other._scope {return false}
    if self._status != other._status {return false}
    if self._transactionID != other._transactionID {return false}
    if self._error != other._error {return false}
    if unknownFields != other.unknownFields {return false}
    return true
  }
...
extension MessageCallRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: MessageCallRequest) -> Bool {
    if self._scope != other._scope {return false}
    if self._network != other._network {return false}
    if self._address != other._address {return false}
...
extension MessageCallResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: MessageCallResponse) -> Bool {
    if self._scope != other._scope {return false}
    if self._status != other._status {return false}
    if self._transactionID != other._transactionID {return false}
    if self._error != other._error {return false}
